        ...
        <StyledHome id = 'home'>
            <Container className = "container">
                <div className="description">
                    <h1>Hey,</h1>
                    <h2>I am <span className = "name">Dhiraj</span></h2>
                    <h2>A <span className = "job">Web Developer</span></h2>
                    <h3>Who can help you build websites that will fly as high as a Rocket.</h3>
                    <div className="buttons">
                        <Link to = "projects" smooth = {true} duration = {400}><button className="work">My Works</button></Link>
                       <Link1 to = '/resume'> <button className="resume">Resume</button></Link1>
                    </div>
                </div>
                <div className="image">
