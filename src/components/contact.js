        ...
        <StyledContact id = "contact">
            <Caontainer>
                ...
                <Details>
                    ...
                    <form action="https://formsubmit.co/dhirajsubudhi540@gmail.com" method="POST">
                        ...
                        <Icon>
                            ...
                            <div className = "gmail">
                                ...
                                <CopyToClipboard text = "dhirajsubudhi540@gmail.com">
                                    <img onMouseEnter = {showCopy} onMouseLeave = {notShowCopy} src={gmail} alt="gmail" />
                                </CopyToClipboard>
                                <CopyToClipboard text = "dhirajsubudhi540@gmail.com">
                                   <p onMouseEnter = {showCopy} onMouseLeave = {notShowCopy}>Dhirajsubudhi540@gmail.com</p>
                                </CopyToClipboard>
